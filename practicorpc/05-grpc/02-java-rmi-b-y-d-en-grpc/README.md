...
Desde esta carpeta (`05-grpc/02-java-rmi-b-y-d-en-grpc/`):
...
En este workspace no estaba instalado `protoc` globalmente, así que quedaron preparados los `.proto`, el código del server y el cliente, y los comandos de generación.
